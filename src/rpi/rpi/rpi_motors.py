...
class StepperMotorNode(Node):
    def __init__(self):
        ...
        self.left_direction_pub = self.create_publisher(Float32, 'left_motor_direction', 10)
        self.right_direction_pub = self.create_publisher(Float32, 'right_motor_direction', 10)
